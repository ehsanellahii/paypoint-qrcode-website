    ...
    <>
        ...
        <div className="grow flex items-center overflow-x-scroll scrollbar-hide">
          {cart.map((item) => (
            <div
              key={item.id}
              className="inline-flex h-full items-center bg-gray-100 rounded pl-3 pr-5 mr-3"
            >
              <div className="relative w-14 aspect-square mr-2">
                ...
                />
                {item.quantity > 1 && (
                  <div className="absolute bottom-0 right-0 bg-[#ffc338] text-black text-xs font-bold rounded-tl px-1">
                    {item.quantity}
                  </div>
                )}
            </div>
        ...
        <div className="ml-4">
          <div className={`w-full font-medium h-full rounded py-2 px-5 inline-flex items-center justify-center ${
