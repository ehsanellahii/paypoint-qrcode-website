...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div 
          className="absolute top-full right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50"
          role="menu"
        ...
        >
          {Object.entries(flags).map(([lang, flag]) => (
            <button
              ...
              className={`w-full flex items-center justify-center hover:bg-gray-50 py-2 px-3 transition-colors ${
