...
const flags = {
  de: (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 513 342' className='w-7 md:w-8 h-7 md:h-6 rounded'>
...
export default function LanguageSwitcher() {
  ...
  return (
    <div className='relative' ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className='absolute top-full -left-3 md:right-0  mt-2 bg-white rounded-xl shadow-lg border border-gray-200 py-2 md:py-1.5 z-50' role='menu' aria-label='Language options'>
