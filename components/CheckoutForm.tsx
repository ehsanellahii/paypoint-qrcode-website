...
import { getPostalRateInfo, storage } from '@/lib/utils';
...
export default function CheckoutForm({ onSuccess, onBack, storeInfo }: CheckoutFormProps) {
    ...
    return (
      <>
        <DialogHeader className='p-6 pb-0 border-b-0'>
          <DialogTitle className='text-3xl border-b py-8 border-gray-300 font-bold text-center'>{t.paymentMethod}</DialogTitle>
        </DialogHeader>
        <div className='flex flex-col h-full'>
          ...
          <div className='border-t border-gray-300 px-6 py-4 space-y-3 bg-white'>
            <div className='flex items-center justify-between text-lg font-bold'>
              ...
              <span>{formatPrice(totalPrice + Number(deliveryCharges))}</span>
            </div>
  ...
  return (
    <>
      <DialogHeader className='p-6 pb-0 border-b-0'>
        <DialogTitle className='text-3xl border-b py-8 border-gray-300 font-bold text-center'>{t.enterDetails}</DialogTitle>
      </DialogHeader>
      <div className='flex flex-col h-full'>
